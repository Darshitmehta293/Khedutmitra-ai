...
import {
  ...
  PiggyBank, MessageSquare, LogOut, Leaf
} from 'lucide-react'
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-surface flex">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-gray-100 fixed h-full z-20">
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-bold text-gray-900 text-sm leading-tight">KhedutMitra</div>
      ...
      {/* Mobile header */}
      <div className="md:hidden fixed top-0 left-0 right-0 bg-white border-b border-gray-100 z-20 flex items-center justify-between px-4 py-3">
